...
if __name__ == "__main__":
    ...
    task_name = "Task501_10pBraTS2023"
    downloaded_data_dir = "/home/aiotlabws/SonDinh/nnUNet_raw_data/Task501_10pBraTS2023/imagesTr"
    ...
    for p in subfiles(cur, join=False):
        ...
        shutil.copy(join("/home/aiotlabws/SonDinh/nnUNet_raw_data/Task501_10pBraTS2023/labelsTr",filename), join(target_labelsTr, p + ".nii.gz"))
        
    
    # Chuyen doi ten sang dung Form TEST
    downloaded_data_dir_test = "/home/aiotlabws/SonDinh/nnUNet_raw_data/Task501_10pBraTS2023/imagesTs"
    patient_namesTs = []
    ...
    if isdir(downloaded_data_dir_test):
        for p in subfiles(downloaded_data_dir_test, join=False):
            ...
            shutil.copy(join("/home/aiotlabws/SonDinh/nnUNet_raw_data/Task501_10pBraTS2023/labelsTs",filename), join(target_labelsTs, p + ".nii.gz"))
